...
const services = [
  ...
  { title: "Air Freight", icon: Plane, href: "/services/air-freight-cyprus", description: "Express air cargo services" },
  { title: "Car Shipping from UK", icon: Car, href: "/services/car-shipping-from-uk-to-cyprus", description: "Vehicle shipping from UK to Cyprus" },
