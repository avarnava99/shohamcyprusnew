...
const services = [
  { title: "Oil & Gas Agency", href: "/port-agency/oil-gas", description: "Offshore operations and oil & gas support" },
  { title: "Crew Changes", href: "/port-agency/crew-changes", description: "Crew change coordination and logistics" },
  { title: "STS Operations", href: "/port-agency/sts", description: "Ship-to-ship transfer operations" },
  { title: "Owners Protecting Agency", href: "/port-agency/owners-protecting", description: "Protecting agency services" },
  { title: "DryDock Service", href: "/port-agency/drydock", description: "Drydock coordination and support" },
  { title: "Vessel Repairs", href: "/port-agency/repairs", description: "Vessel repair coordination" },
  { title: "Change of Ownership", href: "/port-agency/ownership", description: "Ownership transfer services" },
  { title: "Yacht Agency", href: "/port-agency/yacht", description: "Yacht and superyacht services" },
];
