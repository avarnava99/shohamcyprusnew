...
interface ContainerSpec {
  ...
  externalDimensions: { length: string; width: string; height: string };
  internalDimensions: { length: string; width: string; height: string };
...
const containerSpecs: ContainerSpec[] = [
  // Dry Containers
  {
    name: "20' Standard",
    category: "dry",
    externalDimensions: { length: "6,058 mm / 19'10½\"", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "5,898 mm / 19'4\"", width: "2,352 mm / 7'9\"", height: "2,393 mm / 7'10\"" },
    doorOpening: { width: "2,340 mm / 7'8\"", height: "2,280 mm / 7'6\"" },
  ...
  },
  {
    name: "40' Standard",
    category: "dry",
    externalDimensions: { length: "12,192 mm / 40'", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "12,032 mm / 39'6\"", width: "2,352 mm / 7'9\"", height: "2,393 mm / 7'10\"" },
    doorOpening: { width: "2,340 mm / 7'8\"", height: "2,280 mm / 7'6\"" },
  ...
  },
  {
    name: "40' High Cube",
    category: "dry",
    externalDimensions: { length: "12,192 mm / 40'", width: "2,438 mm / 8'", height: "2,896 mm / 9'6\"" },
    internalDimensions: { length: "12,032 mm / 39'6\"", width: "2,352 mm / 7'9\"", height: "2,698 mm / 8'10\"" },
    doorOpening: { width: "2,340 mm / 7'8\"", height: "2,585 mm / 8'6\"" },
  ...
  },
  {
    name: "45' High Cube",
    category: "dry",
    externalDimensions: { length: "13,716 mm / 45'", width: "2,438 mm / 8'", height: "2,896 mm / 9'6\"" },
    internalDimensions: { length: "13,556 mm / 44'6\"", width: "2,352 mm / 7'9\"", height: "2,698 mm / 8'10\"" },
    doorOpening: { width: "2,340 mm / 7'8\"", height: "2,585 mm / 8'6\"" },
  ...
  // Reefer Containers
  {
    ...
    category: "reefer",
    externalDimensions: { length: "6,058 mm / 19'10½\"", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "5,444 mm / 17'10\"", width: "2,268 mm / 7'5\"", height: "2,272 mm / 7'5\"" },
    doorOpening: { width: "2,260 mm / 7'5\"", height: "2,182 mm / 7'2\"" },
  ...
  },
  {
    ...
    category: "reefer",
    externalDimensions: { length: "12,192 mm / 40'", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "11,561 mm / 37'11\"", width: "2,268 mm / 7'5\"", height: "2,198 mm / 7'3\"" },
    doorOpening: { width: "2,260 mm / 7'5\"", height: "2,182 mm / 7'2\"" },
  ...
  },
  {
    ...
    category: "reefer",
    externalDimensions: { length: "12,192 mm / 40'", width: "2,438 mm / 8'", height: "2,896 mm / 9'6\"" },
    internalDimensions: { length: "11,561 mm / 37'11\"", width: "2,268 mm / 7'5\"", height: "2,509 mm / 8'3\"" },
    doorOpening: { width: "2,260 mm / 7'5\"", height: "2,419 mm / 7'11\"" },
  ...
  // Open Top Containers
  {
    ...
    category: "opentop",
    externalDimensions: { length: "6,058 mm / 19'10½\"", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "5,888 mm / 19'4\"", width: "2,340 mm / 7'8\"", height: "2,315 mm / 7'7\"" },
    doorOpening: { width: "2,340 mm / 7'8\"", height: "2,280 mm / 7'6\"" },
  ...
  },
  {
    ...
    category: "opentop",
    externalDimensions: { length: "12,192 mm / 40'", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "12,022 mm / 39'5\"", width: "2,340 mm / 7'8\"", height: "2,315 mm / 7'7\"" },
    doorOpening: { width: "2,340 mm / 7'8\"", height: "2,280 mm / 7'6\"" },
  ...
  // Flat Rack Containers
  {
    ...
    category: "flatrack",
    externalDimensions: { length: "6,058 mm / 19'10½\"", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "5,620 mm / 18'5\"", width: "2,200 mm / 7'3\"", height: "2,233 mm / 7'4\"" },
  ...
  },
  {
    ...
    category: "flatrack",
    externalDimensions: { length: "12,192 mm / 40'", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "12,064 mm / 39'7\"", width: "2,374 mm / 7'9\"", height: "2,014 mm / 6'7\"" },
    capacity: "N/A (open structure)",
  ...
  },
  {
    ...
    category: "flatrack",
    externalDimensions: { length: "12,192 mm / 40'", width: "2,438 mm / 8'", height: "2,896 mm / 9'6\"" },
    internalDimensions: { length: "12,080 mm / 39'8\"", width: "2,410 mm / 7'11\"", height: "2,103 mm / 6'11\"" },
    capacity: "N/A (open structure)",
  ...
  // Special Equipment
  {
    name: "20' Platform",
    category: "special",
    externalDimensions: { length: "6,058 mm / 19'10½\"", width: "2,438 mm / 8'", height: "224 mm / 9\"" },
    internalDimensions: { length: "6,000 mm / 19'8\"", width: "2,400 mm / 7'10\"", height: "N/A" },
  ...
  },
  {
    name: "40' Platform",
    category: "special",
    externalDimensions: { length: "12,192 mm / 40'", width: "2,438 mm / 8'", height: "625 mm / 2'1\"" },
    internalDimensions: { length: "12,120 mm / 39'9\"", width: "2,380 mm / 7'10\"", height: "N/A" },
    capacity: "N/A (flat platform)",
  ...
  },
  {
    ...
    category: "special",
    externalDimensions: { length: "6,058 mm / 19'10½\"", width: "2,438 mm / 8'", height: "2,591 mm / 8'6\"" },
    internalDimensions: { length: "N/A (cylindrical tank)", width: "N/A", height: "N/A" },
...
const ContainerCard = ({ container }: { container: ContainerSpec }) => {
    ...
    <div className="space-y-10">
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
        ...
        <div className="flex flex-wrap gap-4">
          <a 
            href="https://www.zim.com/services/shipping-equipment" 
            target="_blank" 
          ...
          <a 
            href="https://www.zim.com/tools-and-info/container-specifications" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-primary hover:underline flex items-center gap-1 text-sm"
          >
